    ...
    public class RequestedCNResponse : ImisApiResponse
    {
        ...
        private void SetMessage(int value)
        {
            switch (value)
            {
                case 0:
                    msg.Code = value;
                    msg.MessageValue = new Modules.Helpers.Messages.Language().GetMessage(language, "Success");
                    Message = msg;
                    break;
                case 1:
                    msg.Code = value;
                    msg.MessageValue = new Modules.Helpers.Messages.Language().GetMessage(language, "WrongInternalIdFormat");
                    Message = msg;
                    break;
                case 2:
                    ...
                    msg.Code = value;
                    msg.MessageValue = new Modules.Helpers.Messages.Language().GetMessage(language, "InvalidInternalId") + Ids_string;
                    Message = msg;
                    break;
            }
        }
