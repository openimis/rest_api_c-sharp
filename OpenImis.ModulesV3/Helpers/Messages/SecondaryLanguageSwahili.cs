...
{
    public static class SecondaryLanguageSwahili
    {
        // Swahili error message
        // To use this list, rename the file and class to SecondaryLanguage (replace the French translation)
