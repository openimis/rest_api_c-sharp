...
namespace OpenImis.ModulesV3.Helpers.Messages
{
    public static class SecondaryLanguage
    {
        ...
        public static string InValidINmissingPC = "2. Assurance non valide ou produit manquant.";
        public static string InValidEOC = "3. Code d'agent d'adhésion non valide.";
        public static string IncompatibleEO_PC = "4. Le code d'agent d'adhésion et le code du produit d’assurance ne sont pas compatibles.";
