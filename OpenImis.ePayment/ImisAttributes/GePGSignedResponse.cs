...
{
    class GePGSignedResponse
    {
        internal interface IGePGSignedResponseConstraint : IActionConstraint
        { }
        /// <summary>
        /// A filter that specifies the supported request content types. <see cref="ContentTypes"/>
        /// </summary>
        [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, AllowMultiple = false, Inherited = true)]
        public class GePGSignedResponseAttribute :
                Attribute,
                IResourceFilter,
                IActionConstraint,
                IGePGSignedResponseConstraint,
                IApiRequestMetadataProvider
        {
            ...
            /// </summary>
            public GePGSignedResponseAttribute()
            {


                ContentTypes = GetContentTypes("application/xml");
            }
            ...
            public bool Accept(ActionConstraintContext context)
            {
                ...
                foreach (var candidate in context.Candidates)
                {
                    ...
                    if (candidate.Constraints == null || candidate.Constraints.Count == 0 ||
                        candidate.Constraints.Any(constraint => constraint is IGePGSignedResponseConstraint &&
            ...
            private bool IsApplicable(ActionDescriptor actionDescriptor)
            {
                ...
                return actionDescriptor.FilterDescriptors.Last(
                    filter => filter.Filter is IGePGSignedResponseConstraint).Filter == this;
            }
