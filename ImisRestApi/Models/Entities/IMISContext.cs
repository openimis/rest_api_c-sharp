...
{
    /// <summary>
    /// This class is the link with the IMIS DB and define the DB Context
    /// </summary>
    public partial class IMISContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.TempFamily'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.TempInsuree'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.TempPolicy'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.TempPremium'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.tblEmailSettings'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.tempHF'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.tempCatchment'. Please see the warning messages.
