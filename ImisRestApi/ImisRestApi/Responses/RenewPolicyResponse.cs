...
namespace ImisRestApi.Responses
{
    public class RenewPolicyResponse : ImisApiResponse
    {
        ...
        public RenewPolicyResponse(int value,bool error):base(value,error)
        {
            SetMessage(value);
        }
        public RenewPolicyResponse(int value,bool error,DataTable data):base(value,error,data)
        {
            SetMessage(value);
        }
        ...
        private void SetMessage(int value)
        {
            switch (value)
            {
                ...
                case 4:
                    msg.Code = value;
                    msg.MessageValue = "Wrong or missing renewal date";
                    Message = msg;
                    break;
                case 5:
                    msg.Code = value;
